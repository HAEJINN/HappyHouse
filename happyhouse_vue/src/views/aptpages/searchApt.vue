...
<template>
  <div>
    <input type="radio" name="selectType" id="sigungu" value="sigungu" v-model="ckType" />
    <label for="sigungu">시,군,구 검색</label>
    <input type="radio" name="selectType" id="aptname" value="aptname" v-model="ckType" />
    <label for="aptname">아파트 이름 검색</label>
    <input type="radio" name="selectType" id="dongname" value="dongname" v-model="ckType" />
